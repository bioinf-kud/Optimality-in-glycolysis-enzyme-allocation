...
head1<-"/figureS11/data/"
head<-"/figureS11/data/group_gene_list/TCGA-"
...
plot_top3_pathway_gsea <- function(gsea_result, cancer_name, pathway_df, colors = c("#4472C4", "#ED7D31", "#70AD47")) {
  ...
  title_str <- paste0("Top signaling pathways enriched in genes negatively correlated\nwith EOI of glycolysis in TCGA-", cancer_name," tumor samples")
  p<-gseaplot2(
    gsea_result,
    geneSetID = top3_ids,
...
pdf(paste0(dir,"/figureS11/figures/","figureS11a.pdf"), width = 800/96, height = 600/96)
plot_top3_pathway_gsea(gseKEGG1, "BRCA", pathway)
dev.off()
pdf(paste0(dir,"/figureS11/figures/","figureS11b.pdf"), width = 800/96, height = 600/96)
plot_top3_pathway_gsea(gseKEGG3, "HNSC", pathway)
dev.off()
pdf(paste0(dir,"/figureS11/figures/","figureS11c.pdf"), width = 800/96, height = 600/96)
plot_top3_pathway_gsea(gseKEGG4, "KIRC", pathway)
dev.off()
pdf(paste0(dir,"/figureS11/figures/","figureS11d.pdf"), width = 800/96, height = 600/96)
plot_top3_pathway_gsea(gseKEGG5, "LUAD", pathway)
dev.off()
pdf(paste0(dir,"/figureS11/figures/","figureS11e.pdf"), width = 800/96, height = 600/96)
plot_top3_pathway_gsea(gseKEGG6, "LUSC", pathway)
dev.off()
pdf(paste0(dir,"/figureS11/figures/","figureS11f.pdf"), width = 800/96, height = 600/96)
