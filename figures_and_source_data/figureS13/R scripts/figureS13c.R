...
file <- paste0(dir, "/figureS10/data/Ecoli_sum_RMSE.tsv")
...
p<-ggplot(aggrt, aes(x = Glyco_Genes_Sum, y = RMSE, color = Rho_label, label = Description)) +
...
ggsave(paste0(dir,"/figureS10/figures/","figureS10c.pdf"), p, width = 650/96, height = 700/96, units = "in", device = "pdf")
