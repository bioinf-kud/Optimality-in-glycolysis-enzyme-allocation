...
p1<-ggplot(merged, aes(x = Group, y = SpearmanCorrelation)) +
  geom_violin(
    fill = '#AFCBE3', 
    color = "#4472C4", 
    alpha = 0.6, 
...
p2<-ggplot(merged, aes(x = Group, y = SpearmanCorrelation)) +
  geom_violin(
    fill = '#AFCBE3', 
    color = "#4472C4", 
    alpha = 0.6, 
...
ggsave(paste0(dir,"/figure 1/figures/","figure 1d.pdf"), p1, width = 650/96, height = 700/96, units = "in", device = "pdf")
ggsave(paste0(dir,"/figure 1/figures/","figure 1e.pdf"), p2, width = 650/96, height = 700/96, units = "in", device = "pdf")
