...
p<-ggplot(summary) + 
  ...
  labs(
    title = expression(
      atop(
        ...
        "glycolysis enzymes in human tumor samples"
      )
    ),
  ...
  scale_color_manual(
    values = colour,
    labels = c(
      "BRCA (n=1117)", "COAD (n=291)", "HNSC (n=521)", "KIRC (n=541)", 
...
ggsave(paste0(dir,"/figure 4/figures/","figure 4c.pdf"), p, width = 800/96, height = 600/96, units = "in", device = "pdf")
