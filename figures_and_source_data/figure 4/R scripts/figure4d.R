...
p<-ggplot(data) + 
  ...
  labs(
    title = expression(
      atop(
        ...
        "glycolysis enzymes in 378 human cell lines"
      )
    ),
  ...
  xlim(-6, 6) +
  ylim(-6, 6)
ggsave(paste0(dir,"/figure 4/figures/","figure 4d.pdf"), p, width = 650/96, height = 700/96, units = "in", device = "pdf")
