...
head1<-"/figureS12/data/"
head<-"/figureS12/data/group_gene_list/TCGA-"
...
p1<-ggplot(matrix, aes(x=samp, y = Spearman_Correlation)) +
  geom_violin(
    fill = '#AFCBE3', 
    color = "#4472C4", 
    alpha = 0.6, 
...
p2<-ggplot(matrix, aes(x=samp, y = Spearman_Correlation)) +
  geom_violin(
    fill = '#AFCBE3', 
    color = "#4472C4", 
    alpha = 0.6, 
...
ggsave(paste0(dir,"/figureS12/figures/","figureS12a.pdf"), p1, width = 670/96, height = 700/96, units = "in", device = "pdf")
ggsave(paste0(dir,"/figureS12/figures/","figureS12c.pdf"), p2, width = 670/96, height = 700/96, units = "in", device = "pdf")
